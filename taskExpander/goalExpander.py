...
def main(goal, output_file):
    max_depth = DEPTH_CONFIG['max_depth']
    logger.info(f"Starting task expansion for goal: '{goal}' with max depth of {max_depth}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--goal", default=DEFAULT_GOAL, required=True, help="The main goal to expand into tasks")
    args = parser.parse_args()

    DEPTH_CONFIG['max_depth'] = args.max_depth
